...
local repositoryURL = "https://raw.githubusercontent.com/IgorTimofeev/EngineerOS/master/"
local installerURL = "Installer/"
local EFIURL = "EFI/Minified.lua"

local installerPath = "/EngineerOS installer/"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "EngineerOS")
	return y + 2
end
...
local installerMenu = menu:addContextMenuItem("EngineerOS", 0x2D2D2D)
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("EngineerOS HDD")
	end
	...
	EEPROMProxy.setLabel("EngineerOS EFI")
